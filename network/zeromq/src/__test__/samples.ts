import type { AccountUuid, NodeUuid, WorkspaceUuid } from '@hcengineering/network'
import { StaticNodeDiscovery, StaticWorkspaceDiscovery } from '@hcengineering/network'
